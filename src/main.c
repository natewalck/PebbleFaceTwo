...
//   APP_LOG(APP_LOG_LEVEL_INFO , "Frame Origin x is %i", time_layer_frame.origin.y);
  ...
  s_weather_layer = text_layer_create(GRect(8, 99, 132, 88));
  ...
  s_battery_layer = text_layer_create(GRect(8, 99, 128, 88));
  ...
  // Create Date Layer
  s_date_layer = text_layer_create(GRect(8, 34, 128, 88));
